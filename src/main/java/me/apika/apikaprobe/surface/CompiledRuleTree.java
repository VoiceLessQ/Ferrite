 ...
 * blockstate ID table its OP_BLOCK immediates index into + metadata
 * about whether the source tree contained any nodes the compiler
 * doesn't recognise.
 *
...
public record CompiledRuleTree(
	...
	public static CompiledRuleTree fallbackOnly() {
		return new CompiledRuleTree(new byte[]{RuleBytecode.OP_FALLBACK}, true, 1, new Object[0]);
	}
}
